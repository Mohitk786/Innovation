...
const Card = (props) => {
  ...
  return (
      <div onClick={()=>props.openSlideshow ? props.openSlideshow(props.index) : navigate('/gallery')}  className="bg-white cursor-pointer border-2 border-white rounded-lg overflow-hidden shadow-md">
